...
<div id="status" style="font-size:14px;padding:12px 0">
	<form id="form_status" style="font-size:12px">
		...
		Result:<s:select name="res" cssStyle="width:160px" list="#{'0':'All','1':'Accepted','2':'Wrong Answer','3':'Time Limit Exceed','4':'Runtime Error','5':'Presentation Error','6':'Compile Error','7':'Processing'}" />&nbsp;&nbsp;
