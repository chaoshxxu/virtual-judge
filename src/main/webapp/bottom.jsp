...
<div style="text-align:center;margin-top:30px;clear:both;font-size:80%">
	<hr />FAQ | About Virtual Judge | <a href="https://groups.google.com/group/virtual-judge" target="_blank">Forum</a> | <a href="${contextPath}/discuss.action" target="_blank">Discuss</a> | <a href="http://code.google.com/p/virtual-judge/" target="_blank">Open Source Project</a><br />
