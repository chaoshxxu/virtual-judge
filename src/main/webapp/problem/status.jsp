...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<form id="form_status">
			...
			Result:<s:select name="res" list="#{'0':'All','1':'Accepted','2':'Presentation Error','3':'Wrong Answer','4':'Time Limit Exceed','5':'Memory Limit Exceed','6':'Output Limit Exceed','7':'Runtime Error','8':'Compile Error','9':'Unknown Error','10':'Queuing && Judging','11':'Submit Error'}" />&nbsp;&nbsp;
